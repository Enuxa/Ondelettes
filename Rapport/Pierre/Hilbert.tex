...
\begin{document}
	...
	%Revenons au problème précédent, celui de trouver une base pour $D_I$. On cherche à écrire toute fonction $f \in D_I$ comme un "polynôme infini", autrement dit trouver une suite $\{a_n\}_{n \in \mathbb{N}} \subseteq \mathbb{R}$ telle que $$\lim\limits_{n} \left\|\sum_{k = 0}^n a_n X^n - f\right\| = 0$$
	%où $\|\cdot\|$ est une norme sur $D_I$.
